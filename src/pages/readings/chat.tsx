...
import { ChatReading } from "@/components/readings/ChatReading";
    ...
    <div className="app-background min-h-screen flex flex-col dark">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="glass-effect rounded-lg p-6">
          <h1 className="alex-brush text-4xl pink-text mb-6 text-center header-glow">Chat Reading</h1>
          ...
          {reader ? (
            ...
            <>
              <p className="text-center text-white mb-8">
                Select a reader to start a chat reading
              </p>
...
const ChatReadingRoute = () => <ProtectedRoute Component={ChatReadingPage} />;

export default ChatReadingRoute;