...
import { VideoReading } from "@/components/readings/VideoReading";
    ...
    <div className="app-background min-h-screen flex flex-col dark">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="glass-effect rounded-lg p-6">
          <h1 className="alex-brush text-4xl pink-text mb-6 text-center header-glow">Video Reading</h1>
          ...
          {reader ? (
            ...
            <>
              <p className="text-center text-white mb-8">
                Select a reader to start a video reading
              </p>
...
const VideoReadingRoute = () => <ProtectedRoute Component={VideoReadingPage} />;

export default VideoReadingRoute;